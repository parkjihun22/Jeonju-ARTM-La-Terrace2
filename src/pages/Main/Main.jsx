...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `KTX 전주역 생활권`,
    text2: `KTX 전주역을 가까이 누리는 편리한 입지<br/>
            전주 주요 생활권으로 이어지는 교통환경`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `편리한 교통환경`,
    text2: `전주역을 중심으로 편리하게 이어지는 교통망<br/>
            도심 주요 생활권으로 이동이 편리한 입지`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `풍부한 생활 인프라`,
    text2: `전주 도심의 다양한 생활 인프라를 누리는<br/>
            일상의 편리함을 더하는 우아동 생활권`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `차별화된 주거가치`,
    text2: `아파트 300세대와 오피스텔 22실로 구성된<br/>
            전주 아르티엠 라 테라스 주상복합`,
...
<div className={styles.mainImageTextSub}>
  전주에서 만나는{" "}
  <span className={styles.greyText}>차별화된 주거 라이프</span>
</div>
...
<div className={styles.mainImageTitleBox}>
  ...
  <div className={styles.mainImageDesc}>
    전북특별자치도 전주시 덕진구 우아동3가에 조성되는<br/>
    아파트 300세대와 오피스텔 22실 규모의 주상복합<br/>
    편리한 생활과 차별화된 공간 가치를 만나보세요.
  </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - KTX 전주역을 가까이 누리는 편리한 교통환경<br />
                  - 아파트 300세대·오피스텔 22실로 구성된 주상복합<br />
                  - 전용 84㎡ A·B·C·D 타입의 다양한 주거공간<br />
                  - 전주 도심의 생활 인프라를 편리하게 누리는 우아동 생활권<br />
                  - 인후공원·도당산을 가까이 누리는 쾌적한 자연환경
                </div>
              ...
              <div className={styles.textBox}>
                ...
                <div className={styles.subTitle}>
                  ...
                  <div className={styles.subText}>
                    ...
                    <br />
                    전주 아르티엠 라 테라스가 함께합니다
                  </div>
                </div>
              </div>
              <img
                src={section8Img3}
                alt="전주 아르티엠 라 테라스입지환경소개-image2"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="전주 아르티엠 라 테라스아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="전주 아르티엠 라 테라스브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>전주 아르티엠 라 테라스</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xzebvoyn"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="전주 아르티엠 라 테라스오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <img
            src={mobileImageMain}
            className={styles.mainImage}
            alt="전주 아르티엠 라 테라스 아파트 모바일 메인 이미지"
          />
          ...
          <div className={styles.mainImageTextSub1}>
            KTX 전주역을 가까이 누리는<br/> 편리한 주거환경<br/>
            전주에서 만나는 차별화된 주거 라이프<br/>

            <span className={styles.greyText1}>
              새로운 공간의 가치<br/> 특별한 일상을 만나다
            </span>
            <br />
          </div>
          ...
          <div className={styles.mainImageTitleBox1}>
            ...
            <div className={styles.mainImageDesc1}>
              전북특별자치도 전주시 덕진구 우아동3가에 조성되는<br/>
              아파트 300세대와 오피스텔 22실 규모의 주상복합<br/>
              편리한 생활환경과 차별화된 공간 가치를 담은<br/> 새로운 라이프를 제안합니다.
            </div>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text2}>
              ...
              <div className={styles.text3}>
                - KTX 전주역을 가까이 누리는 편리한 교통환경<br />
                - 아파트 300세대·오피스텔 22실로 구성된 주상복합<br />
                - 전용 84㎡ A·B·C·D 타입으로 구성된 주거공간<br />
                - 전주 도심의 다양한 생활 인프라를 누리는 우아동 생활권<br />
                - 인후공원·도당산을 가까이 누리는 쾌적한 자연환경
              </div>
            <div className={styles.text4}>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 전주 아르티엠 라 테라스에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="전주 아르티엠 라 테라스모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="전주 아르티엠 라 테라스브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="전주 아르티엠 라 테라스오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
